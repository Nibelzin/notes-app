        ...
        dark:bg-zinc-800 dark:text-white dark:border-zinc-700 transition-colors">
            <div className="flex">
                ...
                <div className="flex items-center gap-3">
                    <div className="relative" ref={deleteBoxref}>
                        ...
                        {deleteBoxVisible && <DeleteConfirm onCancel={handleDeleteBoxClickOutside} onDelete={() => props.deleteNote(newNote._id)} />}
                    </div>
                </div>
            </div>
            ...
            <div className="flex justify-between">
                ...
                <div ref={selectCategoryBoxRef}>
                    ...
                    {selectCategoryBoxVisible && <SelectCategory onCancel={handleSelectCatBoxClickOutside} notesCategories={props.notesCategories} id={newNote._id} category={newNote.category} closeSelect={handleSelectCatBoxClose} />}
                </div>
            </div>
        </div>
    )
